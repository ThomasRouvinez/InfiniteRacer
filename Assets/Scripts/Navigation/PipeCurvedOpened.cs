...
public class PipeCurvedOpened : PipeBehaviour {
	...
	void Awake(){
		...
		obstacles[1] = obsPC5;		densities[1] = 90;		sizes[1] = 0.5f;
		obstacles[2] = obsPC6;		densities[2] = 90;		sizes[2] = 0.5f;
	...
	private IEnumerator spawn(){
		...
		// Spawn strategy.
		while(density < densityMax && minPosition < 0.8f && (unlocks -1) > -1){	// Synchronize progressive introduction of obstacles.
